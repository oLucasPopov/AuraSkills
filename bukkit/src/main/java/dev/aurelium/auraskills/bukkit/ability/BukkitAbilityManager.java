...
import dev.aurelium.auraskills.bukkit.skills.engineering.EngineeringAbilities;
...
import dev.aurelium.auraskills.bukkit.skills.husbandry.HusbandryAbilities;
...
import dev.aurelium.auraskills.bukkit.skills.trading.TradingAbilities;
...
public class BukkitAbilityManager extends AbilityManager {
    ...
    public void registerAbilityImplementations() {
        ...
        registerAbilityImpl(new EngineeringAbilities(plugin));
    }
