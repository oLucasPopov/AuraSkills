...
<table data-full-width="false"><thead><tr><th width="168">Name</th><th width="116">Skill</th><th>Description</th></tr></thead><tbody><tr><td>Replenish</td><td>Farming</td><td>Replants crops automatically for a certain duration. Right click with a hoe and break a crop to activate. Works with wheat, carrots, potatoes, nether wart, and beetroot.</td></tr><tr><td>Treecapitator</td><td>Foraging</td><td>Breaks entire trees instantly for a certain duration. Right-click with an axe and break a log to activate. The algorithm is not final and will be improved later on to work perfectly with all tree types.</td></tr><tr><td>Speed Mine</td><td>Mining</td><td>Gives Haste 10 for a certain duration. Right-click with a pickaxe and break stone or an ore to activate.</td></tr><tr><td>Sharp Hook</td><td>Fishing</td><td>Deal damage to a hooked entity when left-clicking with a fishing rod.</td></tr><tr><td>Terraform</td><td>Excavation</td><td>When digging, break connected blocks instantly in a 4 block radius horizontally for a duration. Right click shovel and dig block to activate.</td></tr><tr><td>Charged Shot</td><td>Archery</td><td>Arrows you shoot will deal more damage based on how far the bow was pulled back, consuming mana in the process. Does more damage per mana consumed. Left click a bow to toggle charged shot mode.</td></tr><tr><td>Absorption</td><td>Defense</td><td>Incoming damage will decrease mana by 2x Minecraft damage instead of your health. Mana will not regenerate while Absorption is active. Left click shield and take damage to activate.</td></tr><tr><td>Lightning Blade</td><td>Fighting</td><td>Increases attack speed by a percent for a duration. Right click sword and attack entity to activate.</td></tr><tr><td>Forge Overdrive</td><td>Smithing</td><td>Furnaces, blast furnaces and smokers within 10 blocks smelt twice as fast and manual extracts give double items for a duration. Right click coal or charcoal to ready, then click a furnace to activate.</td></tr><tr><td>Animal Whisperer</td><td>Husbandry</td><td>Animals within 15 blocks follow you and babies grow faster for a duration. Right click an animal with wheat to ready, then click an animal again to activate.</td></tr><tr><td>Grand Bargain</td><td>Trading</td><td>All trades are 20% cheaper and never run out of stock for a duration. Right click an emerald to ready, then click a villager to activate.</td></tr><tr><td>Blueprint</td><td>Building</td><td>+1.5 placement reach and 15% chance to not consume placed blocks for a duration. Right click bricks to activate.</td></tr><tr><td>Banquet</td><td>Culinary</td><td>You and nearby players gain Saturation and Regeneration for a duration. Right click a bowl to activate.</td></tr><tr><td>Power Surge</td><td>Engineering</td><td>Component crafts have a 50% chance of double output for a duration. Right click redstone dust, then click a crafting table to activate.</td></tr></tbody></table>
...
|-----------------------------|------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| require_sneak               | Replenish, Treecapitator, Speed Mine, Terraform, Lightning Blade, Forge Overdrive, Animal Whisperer, Grand Bargain, Blueprint, Banquet, Power Surge | If true, players must right click and sneak at the same time to ready the mana ability.                                                           |
| check_offhand               | Replenish, Treecapitator, Speed Mine, Terraform, Lightning Blade, Forge Overdrive, Animal Whisperer, Grand Bargain, Blueprint, Banquet, Power Surge | If true, right clicking to place a block from the offhand will not ready the mana ability of the tool in the main hand.                           |
| sneak_offhand_bypass        | Replenish, Treecapitator, Speed Mine, Terraform, Lightning Blade, Forge Overdrive, Animal Whisperer, Grand Bargain, Blueprint, Banquet, Power Surge | If true, sneaking while right clicking with a block in the offhand will ready the mana ability of the tool in the main hand.                      |
...
| radius                      | Forge Overdrive, Animal Whisperer                                | The radius in blocks around the player that the ability affects.                                                                                 |
| discount_percentage         | Grand Bargain                                                    | The percentage discount applied to all trades while the ability is active.                                                                       |
| double_chance               | Power Surge                                                      | The percentage chance that a component craft yields double output while the ability is active.                                                    |
